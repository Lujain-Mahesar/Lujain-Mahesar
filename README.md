...
```ts
const lujain = {
  title: "Final-Year CS Student @ SZABIST Larkana (CGPA 3.56, Merit Scholar)",
  stack: [
    "Python", "Java", "C++", "SQL",
  ...
  launchedProjects: [
    "AI Resume Screening System — NLP-based candidate ranking, deployed on Streamlit",
    "Intel Image Classification — MobileNetV2 fine-tuned, 90.53% accuracy, Dockerized"
  ],
  certifications: [
    "Soft Skills Program — Google / PAFLE",
    "Python Crash Course — Google (via Coursera)"
  ],
  status: "Building an AI-based document fraud detection system (my Final Year Project)",
  openTo: ["Internships", "ML / Data Science roles", "Research collaborations"]
};
```
...
![Skills](https://skillicons.dev/icons?i=python,java,cpp,mysql)

**Frontend**

![Skills](https://skillicons.dev/icons?i=react,ts)

**Backend / Infra**

![Skills](https://skillicons.dev/icons?i=flask,express,docker,githubactions)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-7dd3fc?style=for-the-badge&logo=linkedin&logoColor=1a1a2e)](https://linkedin.com/in/lujain-mahesar)
[![Email](https://img.shields.io/badge/Email-7dd3fc?style=for-the-badge&logo=gmail&logoColor=1a1a2e)](mailto:lujainmahesar@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-7dd3fc?style=for-the-badge&logo=github&logoColor=1a1a2e)](https://github.com/Lujain-Mahesar)
